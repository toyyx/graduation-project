...
def get_resource_path(relative_path):
    if hasattr(sys, '_MEIPASS'):
        ...
        return os.path.join(osp.dirname(osp.abspath(__file__)) , relative_path)
...
def main():
    ...
    local_config_file = os.path.join("config","default_config.yaml")
    local_config_file = get_resource_path(local_config_file)
